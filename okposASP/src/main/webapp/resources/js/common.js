...
$('.btn.btn-hover').hover(switchColorBgc, switchColorBgc);
...
$('.btn.btn-hover.btn-gradient-black').hover(btnGradientBlack2, btnGradientBlakc1);
...
$('.btn.btn-hover.btn-gradient-lightgray').hover(btnGradientLightgray2, btnGradientLightgray1);
...
$('.btn.btn-hover.btn-gradient-danger').hover(btnGradientDanger2, btnGradientDanger1);
...
$('.btn.btn-hover.btn-gradient-orange').hover(btnGradientOrange2, btnGradientOrange1);
...
$('.btn.btn-hover.btn-gradient-greentea').hover(btnGradientGreentea2, btnGradientGreentea1);
